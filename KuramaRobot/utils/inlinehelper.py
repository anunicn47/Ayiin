...
from KuramaRobot import BOT_USERNAME, OWNER_ID, pgram, arq
from KuramaRobot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from KuramaRobot.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/49323ceede7f8d9d626b6.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/Kurama9T_bot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Kurama](https://github.com/repo is private):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/kuramaub_bot)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/4fc3947c4f32e3685ab8a.jpg",
