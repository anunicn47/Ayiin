...
from KuramaRobot.__main__ import STATS, TOKEN, USER_INFO
from KuramaRobot.modules.sql import SESSION
import KuramaRobot.modules.sql.userinfo_sql as sql
...
from KuramaRobot.modules.redis.afk_redis import is_user_afk, afk_reason
from KuramaRobot.modules.sql.users_sql import get_user_num_chats
from KuramaRobot.modules.helper_funcs.chat_status import sudo_plus
from KuramaRobot.modules.helper_funcs.extraction import extract_user
from KuramaRobot import telethn
...
def info(update: Update, context: CallbackContext):
    ...
    if user_id not in [bot.id, 777000, 1087968824]:
        ...
        text += f"\n\n<b>Health:</b> <code>{userhp['earnedhp']}/{userhp['totalhp']}</code>\n[<i>{make_bar(int(userhp['percentage']))} </i>{userhp['percentage']}%]. [<a href='https://t.me/Kurama_sumpport_groump/6974'>?</a>]"
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThe Disaster level of this person is 'ANGEL'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Kurama_sumpport_groump/6969">?</a>]'.format(
            bot.username,
        )
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + f"\n\n[✦ Support](https://t.me/{SUPPORT_CHAT}) | [✦ Updates](https://t.me/Kurama_sumpport_groump)\n\n"
            + "╘══「 by [Shiv](https://github.com/Narutoo06) 」\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
...
*What is that health thingy?*
 Come and see [HP System explained]()
"""
