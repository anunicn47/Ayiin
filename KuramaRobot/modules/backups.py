...
import KuramaRobot.modules.sql.notes_sql as sql
from KuramaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from KuramaRobot.__main__ import DATA_IMPORT
...
from KuramaRobot.modules.rules import get_rules
import KuramaRobot.modules.sql.rules_sql as rulessql

from KuramaRobot.modules.sql import warns_sql as warnssql
import KuramaRobot.modules.sql.blacklist_sql as blacklistsql
from KuramaRobot.modules.sql import disable_sql as disabledsql

from KuramaRobot.modules.sql import cust_filters_sql as filtersql
import KuramaRobot.modules.sql.welcome_sql as welcsql
import KuramaRobot.modules.sql.locks_sql as locksql
from KuramaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("KuramaRobot{}Backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KuramaRobot{}Backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Kurama-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl,
        ),
        timeout=360,
    ...
    os.remove("KuramaRobot{}Backup".format(chat_id))  # Cleaning file
