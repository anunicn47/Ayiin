...
from KuramaRobot import LOGGER
...
def extract_user_and_text(
    ...
    try:
        ...
        if excp.message in ("User_id_invalid", "Chat not found"):
            message.reply_text(
                "kurama seems to have never interacted with this user before - please forward a message from "
                "kurama needs to have interacted with them in order for some commands to work"
            )
        else:
