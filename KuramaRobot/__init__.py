...
if ENV:
    ...
    DB_URI = os.getenv("DATABASE_URL").replace("postgres://", "postgresql://")# Any database Database Link (RECOMMENDED:- PostgreSQL & https://www.elephantsql.com)
    ...
    REDIS_URL = 'redis://:1x1VQ5BPfvOpvijthqD8jt7jIGQTaXil@redis-18712.c289.us-west-1-2.ec2.cloud.redislabs.com:18712'
    BOT_ID = int(os.environ.get("BOT_ID", None)) # Telegram Bot ID 
    ...
    KURAMA_PHOTO = os.environ.get("KURAMA_PHOTO", True)
    
    
    GBAN_GIF = os.environ.get('GBAN_GIF',
                                 'https://telegra.ph/file/e5d9ebebc8a7d058825d9.mp4')
    BAN_GIF = os.environ.get('BAN_GIF',
                                 'https://telegra.ph/file/3017428e5154efcd9bd7c.mp4')
    UNGBAN_GIF = os.environ.get('UNGBAN_GIF',
                                 'https://telegra.ph/file/7bfaef95769091d7f06e3.mp4')
    N_GIF = os.environ.get('N_GIF',
                                 'https://telegra.ph/file/d729424367533b87445c3.mp4')
    D_GIF = os.environ.get('D_GIF',
                                 'https://telegra.ph/file/ecff879c471f741982ead.mp4')
    DR_GIF = os.environ.get('DR_GIF',
                                 'https://telegra.ph/file/ecff879c471f741982ead.mp4')
    DM_GIF = os.environ.get('DM_GIF',
                                 'https://telegra.ph/file/ecff879c471f741982ead.mp4')
    ...
    from KuramaRobot.config import Development as Config
    ...
    N_GIF = Config.N_GIF
    D_GIF = Config.D_GIF
    DR_GIF= Config.DR_GIF
    DM_GIF= Config.DM_GIF
    ...
    KURAMA_PHOTO = Config.KURAMA_PHOTO
...
try:
    ...
    LOGGER.info("[]: Connecting To Yūki • Data Center • Mumbai • Redis Database")

except BaseException:

    raise Exception("[KURAMA ERROR]: Your Yūki • Data Center • Mumbai • Redis Database Is Not Alive, Please Check Again.")

finally:

   REDIS.ping()

   LOGGER.info("[KURAMA]: Connection To The Yūki • Data Center • Mumbai • Redis Database Established Successfully!")
    

if not SPAMWATCH_API:
    sw = None
    LOGGER.warning("[KURAMA ERROR]: SpamWatch API key Is Missing! Recheck Your Config.")
else:
    try:
        sw = spamwatch.Client(SPAMWATCH_API)
    except:
        sw = None
        LOGGER.warning("[KURAMA ERROR]: Can't connect to SpamWatch!")



print("[KURAMA]: Telegraph Installing")
telegraph = Telegraph()
print("[KURAMA]: Telegraph Account Creating")
telegraph.create_account(short_name='kurama')
...
print("[KURAMA]: TELETHON CLIENT STARTING")
telethn = TelegramClient(MemorySession(), API_ID, API_HASH)
dispatcher = updater.dispatcher
print("[KURAMA]: PYROGRAM CLIENT STARTING")
...
print("[KURAMA]: Connecting To kurama • Data Center • Mumbai • MongoDB Database")
...
print("[KURAMA]:Connecting to PostgreSQL Database")
ubot = TelegramClient(StringSession(STRING_SESSION), APP_ID, APP_HASH)
print("[KURAMA]:connecting to userbot")
...
from KuramaRobot.modules.helper_funcs.handlers import (
